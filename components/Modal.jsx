...
const Modal = () => {
  ...
  return (
    <div className="bg-overlay-black dark:bg-overlay-dark h-full w-full overflow-auto fixed top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2  z-30 lg:flex justify-center items-center">
      <div className=" bg-white dark:bg-night-blue h-auto mx-auto lg:mx-0 my-10 lg:my-0  w-4/5 lg:w-2/3 py-8 rounded-md px-6 lg:px-8  relative">
        {/* modal header */}
